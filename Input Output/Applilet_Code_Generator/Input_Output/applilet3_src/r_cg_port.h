...
#define _00_ADPC_DI_OFF         (0x00U) /* use P20 - P27 and P150 - P156 as analog input */
#define _0F_ADPC_DI_ON          (0x0FU) /* use P156 as digital input */
#define _0E_ADPC_DI_ON          (0x0EU) /* use P155 - P156 as digital input */
#define _0D_ADPC_DI_ON          (0x0DU) /* use P154 - P156 as digital input */
#define _0C_ADPC_DI_ON          (0x0CU) /* use P153 - P156 as digital input */
#define _0B_ADPC_DI_ON          (0x0BU) /* use P152 - P156 as digital input */
#define _0A_ADPC_DI_ON          (0x0AU) /* use P151 - P156 as digital input */
#define _09_ADPC_DI_ON          (0x09U) /* use P150 - P156 as digital input */
#define _08_ADPC_DI_ON          (0x08U) /* use P27 and P150 - P156 as digital input */
#define _07_ADPC_DI_ON          (0x07U) /* use P26 - P27 and P150 - P156 as digital input */
#define _06_ADPC_DI_ON          (0x06U) /* use P25 - P27 and P150 - P156 as digital input */
#define _05_ADPC_DI_ON          (0x05U) /* use P24 - P27 and P150 - P156 as digital input */
#define _04_ADPC_DI_ON          (0x04U) /* use P23 - P27 and P150 - P156 as digital input */
#define _03_ADPC_DI_ON          (0x03U) /* use P22 - P27 and P150 - P156 as digital input */
#define _02_ADPC_DI_ON          (0x02U) /* use P21 - P27 and P150 - P156 as digital input */
#define _01_ADPC_DI_ON          (0x01U) /* use P20 - P27 and P150 - P156 as digital input */
...
#define _F8_PM10_DEFAULT        (0xF8U) /* PM10 default value */
#define _FC_PM11_DEFAULT        (0xFCU) /* PM11 default value */
#define _FE_PM12_DEFAULT        (0xFEU) /* PM12 default value */
#define _80_PM15_DEFAULT        (0x80U) /* PM15 default value */
